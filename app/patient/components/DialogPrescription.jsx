...
const DialogPrescription = ({ setDisplayedPrescriptions }) => {
    const { createPrescriptions, setCreatePrescriptions } = useAppContext()
    ...
    const fetchPrescription = async () => {
        ...
        if (querySuccess) {
            setDisplayedPrescriptions(prescriptions.filter(prescription => createPrescriptions.includes(prescription._id)))
        }
    }
    ...
    const handleAddPrescription = () => {
        ...
        let newCreatePrescriptions = [...createPrescriptions]
        newCreatePrescriptions.push(prescriptionId)
        setCreatePrescriptions([...newCreatePrescriptions])
